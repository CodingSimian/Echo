...
//constructor
    public PvPController(){ //Constructorn fungerar som showMatches() men den använder sig av resultList från typedquery som
        ...
        try{
            ...
            PvPList.addAll(somePvPMatches); //testade att skapa somePvPMatches inuti try blocket
    ...
    public void addPvPMatch(int daMatch_Id, int daPlayer_Id1,int daPlayer_Id2, int daGame_Id, String daDate ){
    ...
    public void changeEverythingMatch(PvP matchToBeRemoved,int daMatch_Id,int daPlayer_Id1,int daPlayer_Id2, int daGame_Id, String daDate,int daWinner_ID, int SCORE_P1, int SCORE_P2){
        //Denna metod är till för att ändra på match-poängen. Eftersom man skapar matchen först, sedan efter
        //den är färdiggjord så lägger man till resultatet.
        ...
        try{
            ...
            somePVPMatch.setPlayer_id1(daPlayer_Id1);
            somePVPMatch.setPlayer_id2(daPlayer_Id2);
